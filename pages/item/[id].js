      ...
      <main className="content container">
        ...
        <div className="info-container">
          <h3>
            ...
            {moment(
              moment(props.item.data.date).format("YYYYMMDD"),
              "YYYYMMDD"
            ).fromNow()}
          </h3>
          ...
          <h3>
            ...
            >
              <path
                d="M9.5 29C11.433 29 13 27.2091 13 25C13 22.7909 11.433 21 9.5 21C7.567 21 6 22.7909 6 25C6 27.2091 7.567 29 9.5 29Z"
                stroke="#200E32"
                strokeWidth="2"
                strokeLinecap="round"
              ...
              />
              <path
                d="M26.5 29C28.433 29 30 27.2091 30 25C30 22.7909 28.433 21 26.5 21C24.567 21 23 22.7909 23 25C23 27.2091 24.567 29 26.5 29Z"
                stroke="#200E32"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M20.1053 3H28.7895L34 13M6.21053 25H2.73684V17L6.21053 25ZM1 1H20.1053V25L1 1ZM13.1579 25H23.5789H13.1579ZM30.5263 25H34V13H20.1053L30.5263 25Z"
                stroke="#200E32"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
